...
const Document = () => {
  ...
  const deleteDocument = async (pdfId, index) => {
    try {
  ...
  return (
    <div>
      ...
      {/* <div
        style={{
          position: "absolute", // Full-page container
          top: 0,
          left: 0,
          right: 0,
          bottom: 0,
      ...
      >
        <div
          style={{
            ...
            maxWidth: "80%", // Max width of the inner div
            maxHeight: "80%", // Max height of the inner div
            // Add any additional styling needed for the inner div
          }}
        >
          <Model />
        </div>
      ...
      >
        ...
        >
          <div>
            <p style={{ background: "black" }}>Explore Candidate</p>
          </div>
        </div>
        <div
          style={{
        ...
        >
          <div>
            <p style={{ background: "black" }}>Chat With Pdf</p>
          </div>
        </div>
      </div> */}
      {show && (
          ...
          <div className="flex justify-start mb-4 px-2">
            <div className="flex-inline justify-start items-center w-full">
              <div className="sc-1c859520-0 jHAXMR">
                ...
                <button
                  onClick={handleBoxClick1}
                  className="rounded-md ml-6 bg-indigo-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                >
                  Upload
                </button>
              </div>
                ...
                {filteredDocuments.map((document, index) => {
                  ...
                  return (
                    <tr className="sc-4131da42-3 jSZOxE" key={index}>
                      ...
                      <td className="sc-4131da42-5 jgaYkc">{formattedSize}</td>
                      <td className="sc-4131da42-5 jgaYkc">
                      ...
                      <td className="sc-4131da42-5 jgaYkc">
                        ...
                        >
                          <svg
                            ...
                            viewBox="0 0 16 16"
                          >
                            <path d="M14.49 3.99h-13c-.28 0-.5.22-.5.50s.22.5.5.5h.5v10c0 .55.45 1 1 1h10c.55 0 1-.45 1-1v-10h.5c.28 0 .5-.22.5-.50s-.22-.5-.50-.5zm-8.50 9c0 .55-.45 1-1 1s-1-.45-1-1v-6c0-.55.45-1 1-1s1 .45 1 1v6zm3 0c0 .55-.45 1-1 1s-1-.45-1-1v6c0-.55.45-1 1-1s1 .45 1 1v6zm3 0c0 .55-.45 1-1 1s-1-.45-1-1v6c0-.55.45-1 1-1s1 .45 1 1v6zm2-12h-4c0-.55-.45-1-1-1h-2c-.55 0-1 .45-1 1h-4c-.55 0-1 .45-1 1v1h14v-1c0-.55-.45-1-1-1z"></path>
                          </svg>
                        </button>
                      </td>
                    </tr>
